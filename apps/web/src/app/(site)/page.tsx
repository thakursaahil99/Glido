...
import { ArrowRight, Car, Download, MapPin, Rocket, ShoppingBag, ShoppingCart, UtensilsCrossed } from "lucide-react";
  ...
  return (
    <div>
      ...
      <section className="container-glido py-10">
        <div className="card-glido p-6 md:p-8 bg-gradient-to-br from-[var(--glido-ink)] to-[#2a2f36] text-white border-none flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden relative">
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div>
              <h3 className="font-bold text-lg">Food, grocery and rides — in one app</h3>
              <p className="text-sm text-white/70 mt-1 max-w-md">
                Everything on this site, faster on your phone. Android APK — direct download, no
                Play Store needed.
              </p>
            </div>
          </div>
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-white text-[var(--glido-ink)] font-semibold px-5 py-3 shrink-0 hover:bg-white/90 relative z-10"
          >
