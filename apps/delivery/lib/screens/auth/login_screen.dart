...
class _LoginScreenState extends State<LoginScreen> {
  final _identifierCtrl = TextEditingController(text: 'delivery@glido.app');
  final _passwordCtrl = TextEditingController(text: 'Delivery@123');
  bool _loading = false;
  String? _error;
              ...
              child: Column(
                ...
                children: [
                  Container(
                    height: 56,
                    width: 56,
                    decoration: BoxDecoration(gradient: GlidoGradients.primaryButton(context.colors), borderRadius: BorderRadius.circular(16)),
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(text: 'lido', style: TextStyle(color: context.colors.ink)),
                        TextSpan(text: ' Partner', style: TextStyle(color: context.colors.muted)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 4),
                  Text('Deliver with Glido. Flexible hours, weekly payouts.', style: TextStyle(color: context.colors.muted)),
